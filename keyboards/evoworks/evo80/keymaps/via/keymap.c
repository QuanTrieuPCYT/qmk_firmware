...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_tkl_ansi(
        KC_ESC,  KC_BRID,  KC_BRIU,  KC_WHOM,     KC_MAIL,      KC_CALC,  KC_MSEL,   KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,  MC_1,     MC_2,     KC_SCRL,  KC_PAUS,
        MD_USB,  MD_BLE1,  MD_BLE2,  MD_BLE3,     MD_24G,       KC_5,     KC_6,      KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,  MC_3,     KC_HOME,  KC_PGUP,
        KC_TAB,  LOGO_TOG, KC_W,     KC_E,        KC_R,         KC_T,     KC_Y,      KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,  MC_4,     KC_END,   KC_PGDN,
    ...
    [3] = LAYOUT_tkl_ansi(
        KC_ESC,  KC_F1,    KC_F2,    KC_F3,       KC_F4,        KC_F5,    KC_F6,     KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   MC_1,     MC_2,     KC_SCRL,  KC_PAUS,
        MD_USB,  MD_BLE1,  MD_BLE2,  MD_BLE3,     MD_24G,       KC_5,     KC_6,      KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,  MC_3,     KC_HOME,  KC_PGUP,
        KC_TAB,  LOGO_TOG, KC_W,     KC_E,        KC_R,         KC_T,     KC_Y,      KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,  MC_4,     KC_END,   KC_PGDN,
        KC_CAPS, KC_CAPS,  KC_A,     KC_S,        KC_D,         KC_F,     KC_G,      KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  KC_K42,   MC_0,     MC_0,
        KC_LSFT, KC_K45,   RGB_RTOG, KC_X,        KC_C,         KC_V,     QK_BAT,    KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSFT,  KC_UP,
