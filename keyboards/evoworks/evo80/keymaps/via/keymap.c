...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_tkl_ansi(
        ...
        KC_TAB,  LOGO_TOG, KC_W,     KC_E,        KC_R,         KC_T,     KC_Y,      KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,  KC_DEL,   KC_END,   KC_PGDN,
        KC_CAPS, KC_CAPS,  KC_A,     KC_S,        KC_D,         KC_F,     KC_G,      KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  KC_K42,   KC_ENT,   KC_ENT,
        KC_LSFT, KC_K45,   RGB_RTOG, KC_X,        KC_C,         KC_V,     QK_BAT,    KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSFT,  RGB_SPI,
